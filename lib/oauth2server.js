...
OAuth2Server.prototype.handler = function () {
	...
	return function (req, res, next) {
		...
		var tokenString = '/oauth/token'
		var indexOfTokenString = req.path.indexOf(tokenString);
		if (req.path && indexOfTokenString > -1 && (indexOfTokenString == req.path.length-tokenString.length)) {
